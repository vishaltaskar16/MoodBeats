...
| **YouTube Integration** | ▶️ | Direct YouTube song playback |
...
│   │   ├️── favorites.html     # Favorite songs
...
### **🖥️ Method 1: Automatic (Recommended)**
```bash
# Windows
run.bat
...
**Made with ❤️ by the MoodBeats Team**
